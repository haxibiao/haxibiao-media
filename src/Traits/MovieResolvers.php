    ...
    public function getFilters()
    {
        return [
            [
                ...
                'filterName' => '排序选项',
                'filterOptions' =>
                ['全部'=>'','最新'=>'NEW','最热'=>'HOT','评分'=>'SCORE'],
            ],
            [
                'id' => 'region',
                'filterName' => '剧种',
                'filterOptions' =>
                ['全部'=>'','韩剧'=>'HAN', '日剧'=>'RI', '美剧'=>'MEI', '港剧'=>'GANG'],
            ],
            //此字段中数据为空,暂时不展示此过滤条件
            // [
            //     'id' => 'country',
            ...
            [
                ...
                'filterName' => '年份',
                'filterOptions' =>
                ['全部'=>'', '2020'=>'2020', '2019'=>'2019', '2018'=>'2018', '2017'=>'2018', '2016'=>'2016'],
            ],
            // [
            //     'id' => 'type',
            //     'filterName' => '类型',
            //     'filterOptions' =>
            //     ['全部'=>'', '古装'=>'古装', '武侠'=>'武侠', '都市'=>'都市', '悬疑'=>'悬疑', '言情'=>'言情', '喜剧'=>'喜剧'],
            // ],
        ];
    }
}
