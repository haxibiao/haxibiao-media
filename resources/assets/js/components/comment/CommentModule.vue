  ...
  <div id="comment_module" class="comment-wrapper">
    ...
    <div class="comment-container">
      <div class="comment-box">
        <div class="comment-header clearfix">
          <div class="tabs-order">
            <ul class="clearfix">
              ...
              <li data-order="2" :class="['hot-order', order == 'id' && 'on']" v-on:click="changeCommentsOrder('id')">
                按时间排序
              </li>
            </ul>
          </div>
        ...
        <pagination :count="Number(countComment)" :offset="Number(pageOffset)" :current.sync="currentPage" />
